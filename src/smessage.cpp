...
// Copyright (c) 2014-2015 The charity developers
// Copyright (c) 2015 The charity developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("charity-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("charity-smsg-pow"); // Make this thread recognisable
