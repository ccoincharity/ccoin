...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "charity", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Filling wells!!!!!!!!";
        CTransaction txNew;
        txNew.nTime = 1512336091;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1512336091;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 2521854 : 2521854;
...
//        assert(block.hashMerkleRoot == uint256("0x"));
        assert(block.hashMerkleRoot == uint256("0x53ec8268ffcad65a3135841352156ea59d5aa658655f53926dc59d0aa7b0cba0"));
...
unsigned char pchMessageStart[4] = { 0x29, 0x74, 0x7a, 0x31 };
